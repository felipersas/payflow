...
//
//	mockgen -source=user_repository.go -destination=mock_user_repository.go -package=repositories
//
...
import (
	...
	entities "github.com/felipersas/payflow/internal/user/domain/entities"
